<%@ page contentType="text/html;charset=utf-8" import="java.sql.*, pkb.db.ConnectionPoolBean" %>
<jsp:useBean id="pool" class="pkb.db.ConnectionPoolBean" scope="application" />
