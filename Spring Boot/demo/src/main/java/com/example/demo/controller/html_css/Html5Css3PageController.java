...
import com.example.Homework.CreateTeam;
...
public class Html5Css3PageController {
    ...
    public String getResume() {
        ...
        return "html_css/homework/resume.html";
    }
    ...
    @GetMapping("/webFormWithOptGroup")
    public String getWebFormWithOptGroup() {
        log.info("Enter getWebFormWithOptGroup()");

        return "html_css/form/webFormWithOptGroup.html";
    }

    @GetMapping("/webFormWithLegacy")
    public String getWebFormWithLegacy() {
        log.info("Enter getWebFormWithLegacy()");

        return "html_css/form/webFormWithLegacy.html";
    }
